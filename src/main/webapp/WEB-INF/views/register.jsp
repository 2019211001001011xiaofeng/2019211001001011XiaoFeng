...
style="width: 15px; height: 15px; display:inline;" name="gender" value="Man" checked/>&nbsp;Man&nbsp;<input type="radio" style="width: 15px; height: 15px;   display: inline;" name="gender" value="woman"/>&nbsp;Woman</span>
   <span></span>
