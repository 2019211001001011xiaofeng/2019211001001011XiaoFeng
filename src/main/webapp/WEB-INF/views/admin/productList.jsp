<%@ page import="com.XiaoFeng.model.Category" %>
<%@ page import="com.XiaoFeng.model.Product" %>
					...
					<c:forEach var="p" items="${productList}">
						<tr>
							...
							<%
								...
								java.sql.Connection con= (java.sql.Connection) DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=userdb","sa","123456");
